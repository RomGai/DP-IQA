...
Download the [Koniq-10k](https://osf.io/hcsdy/) dataset (1024x768). Make sure the path of its .csv file is '/koniq/koniq10k_distributions_sets.csv', and the root path of images is 'koniq/1024x768' in your project.
